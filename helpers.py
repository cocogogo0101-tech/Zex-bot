...
✨ تحديث: دعم كامل لمتغيرات الدعوات
"""
...
def replace_variables(text: str, **kwargs) -> str:
    """
    استبدال المتغيرات في النص - نسخة محسّنة مع دعم الدعوات
    ...
    🔹 متغيرات الدعوات (✨ جديد):
        {inviter}      - من دعا العضو (mention أو "غير معروف")
        {invitername}  - اسم الداعي فقط
        {invitecount}  - عدد دعوات الداعي
    
    الاستخدام:
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    >>> replace_variables(
    ...     "مرحباً {mention}! دعاك {inviter}",
    ...     mention="<@123>",
    ...     inviter="<@456>"
    ... )
    "مرحباً <@123>! دعاك <@456>"
    ...
    # القيم الافتراضية للمتغيرات الجديدة
    defaults = {
        # متغيرات الدعوات (جديد ✨)
        'inviter': 'غير معروف',
    ...
    # دمج القيم المرسلة مع الافتراضية
